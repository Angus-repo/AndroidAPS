    ...
    suspend fun getValidAccessToken(): String? = withContext(Dispatchers.IO) {
        try {
            ...
            if (refreshToken.isEmpty()) {
                ...
                showConnectionError(rh.gs(R.string.google_drive_account_not_linked))
            ...
            showConnectionError(rh.gs(R.string.google_drive_token_refresh_failed))
            null
        } catch (e: Exception) {
    ...
    suspend fun testConnection(): Boolean {
        return withContext(Dispatchers.IO) {
            try {
                ...
                if (accessToken == null) {
                    showConnectionError(rh.gs(R.string.google_drive_no_valid_token))
                ...
                if (response.isSuccessful) {
                    ...
                    showConnectionError(rh.gs(R.string.google_drive_connection_test_failed))
                    return@withContext false
                }
            } catch (e: Exception) {
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    showConnectionError(rh.gs(R.string.google_drive_list_folders_failed))
                    return@withContext emptyList()
                }
            } catch (e: Exception) {
