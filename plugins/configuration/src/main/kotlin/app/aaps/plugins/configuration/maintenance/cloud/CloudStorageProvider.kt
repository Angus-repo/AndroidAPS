...
interface CloudStorageProvider {
     ...
     * @param folderId Folder ID (use selected folder if null)
    ...
    /**
     * List all settings files without pagination.
     * @return List of all settings files
     */
    suspend fun listAllSettingsFiles(): List<CloudFile> = emptyList()
    
    // ==================== UI Helpers ====================
    
    /**
     * Show folder selection dialog.
     * This is an optional method that providers can implement for custom folder selection UI.
     */
    fun showFolderSelectionDialog(
        ...
        // Providers can override this to provide custom UI
    }
}
